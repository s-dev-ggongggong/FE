...
/* ****Pages***** */
const ModernDash = Loadable(lazy(() => import('../views/dashboard/Main')));
...
const ViewTraining = Loadable(lazy(()=> import('../views/apps/blog/TrainingView')));
...
const Router = [
  {
    ...
    children: [
      ...
      { path: '/apps/training/view/:id', element: <ViewTraining/> }, 
